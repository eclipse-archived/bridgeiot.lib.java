 ...
 */
public class ParameterEncoderXml extends ParameterEncoder {

    private static final Logger logger = LoggerFactory.getLogger(ParameterEncoderXml.class);
    ...
    public String encode(Object parameters) {
        try {
            ...
            throw new BridgeIoTException("Cannot serial parameter object into Xml", e);
        }
    }
