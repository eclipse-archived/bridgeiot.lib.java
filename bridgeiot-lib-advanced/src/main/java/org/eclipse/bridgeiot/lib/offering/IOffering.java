...
public interface IOffering extends IOfferingCore {

    @Override
    CompletableFuture<AccessResponse> accessOneTime(AccessParameters accessParameters);

    List<AccountingReport> getCurrentAccountingReports();
